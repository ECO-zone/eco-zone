...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='control_area',
            field=models.CharField(choices=[('10YDE-VE-------2', '50Hertz'), ('10YDE-RWENET---I', 'Amprion'), ('10YDE-EON------1', 'TenneT'), ('10YDE-ENBW-----N', 'TransnetBW'), ('10Y1001A1001A83F', 'Germany')], max_length=16, verbose_name='Control area'),
        ),
        migrations.AlterField(
        ...
        migrations.AddConstraint(
            model_name='generation',
            constraint=models.UniqueConstraint(fields=('start',), name='unique_generation_record'),
        ),
    ]
