...
def get_timeseries_classified_redispatch(
    ...
    result = TimeseriesRedispatch.objects.get_timeseries_classified_redispatch_data(start, end)
...
class ZonalEmissionIntensityData(Schema):
    header: Tuple[str, str, str] = ("start", "emission_intensity_north", "emission_intensity")
    rows: List[list] = ((
        datetime.fromisoformat("2025-01-14T00:00:00Z"),
        390.24490576535226,
        150.0
...
def get_emission_intensity_for_region(
    ...
    result = Generation.objects.get_emission_intensity_data_for_region(region, start, end)

    return ZonalEmissionIntensityData(header=result[0], rows=result[1:])


class GenerationData(Schema):
    header: Tuple[str, str, str, str, str, str, str, str, str, str, str, str, str, str, str, str] = (
        "start",
        "B01",
        "B02",
        "B04",
